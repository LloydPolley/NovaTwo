...
const Carousel = ({
  ...
  return (
    <div className="carousel rounded-lg p-2 lg:p-7">
      <div className="flex justify-between border-b-2 border-widgetBlack-400 w-[calc(100%-20px)] lg:w-full ml-5 lg:ml-0 mb-4">
        <h2 className="text-xl capitalize">{text}</h2>
        {url && (
          <Link
